...
class GraphDataset(Dataset):
    ...
    """
    def __init__(self, data_dir, data_df, GIGN_datafold=None, dis_threshold=5, num_pose=1, graph_type='Graph_GIGN', assay_type='pIC50', num_process=8, create=False):
        self.data_dir = data_dir
        self.data_df = data_df
        self.dis_threshold = dis_threshold
        self.num_pose = num_pose
        self.graph_type = 'Graph_DTIGN'
        self.create = create
