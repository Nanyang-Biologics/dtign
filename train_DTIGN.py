...
if __name__ == '__main__':
    ...
    if task_id == 'I1':
        start_fold, skip_fold, stop_fold, warmup_epoch, val_rate, seed, learning_rate, hidden_dim, val_num, subset_num, step_size, gamma, early_stop_epoch, D_count, num_heads = 2, [3], 4, 40, 1, 0, 1e-4, 128, 1, 5, 10, 0.95, 100, 32, 8
    if task_id == 'I2':
