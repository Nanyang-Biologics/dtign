...
class GraphDataset(Dataset):
    ...
    """
    def __init__(self, data_dir, ground_dir, data_df, GIGN_datafold=None, dis_threshold=5, num_pose=1, graph_type='Graph_GIGN', assay_type='pIC50', num_process=8, create=False):
        ...
        self.GIGN_datafold = GIGN_datafold
        self._pre_process()
    ...
    def _pre_process(self):
        ...
        print('ground_pocket_list_all:', ground_pocket_list_all)
        not_found_list = []
            ...
            if pocket_list:
                ...
                if ground_pocket_list:
                    for pocket in ground_pocket_list:
                        ...
                        print('ground_complex_path:', ground_pocket_list_all)
                        complex_path_list_cid.append(complex_path)
